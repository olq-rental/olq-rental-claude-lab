    ...
    <div style={{fontFamily:"'Noto Sans JP','Hiragino Sans',sans-serif",minHeight:"100vh",background:"#f1f5f9",color:"#1e293b"}}>
      ...
      <header className="app-header" style={{background:"#0f172a",color:"#fff",padding:"0 20px",height:52,display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:100,boxShadow:"0 2px 16px rgba(0,0,0,.4)"}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <span style={{fontWeight:800,fontSize:15,letterSpacing:2}}>オルク レンタル伝票管理</span><span style={{fontSize:10,color:"#94a3b8",marginLeft:8,fontWeight:400}}>Ver.1.58</span>
        </div>
      ...
      if (legs.length===1 || !allSame) {
        ...
        legs.forEach(({record:r, line:ln}) => {
          ...
          allInvRows.push({html:`<tr>
            ...
            <td style="border:1px solid #aaa;padding:2px 5px;vertical-align:middle">${equipName}</td>
          ...
          </tr>`, weight:strWidth(equipName)>50?2:1});
        });
      } else {
        ...
        const _cweight=legs.length+(strWidth(_ceqName)>50?2:1);
        allInvRows.push({html:`<tr>
          ...
          <td rowspan="${_legRspan}" style="border:1px solid #aaa;padding:2px 5px;vertical-align:middle">${_ceqName}</td>
