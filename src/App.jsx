  ...
  if (block.type === "chain") {
    ...
    rLines.forEach((ln,li)=>{
      ...
      allInvRows.push({html:`<tr>
        ...
        <td style="border:1px solid #aaa;padding:2px 5px;text-align:center">${equipName}${nameExtra}${li===0&&(r.notes||"").indexOf("【日数調整】")>=0&&(r.adjustReason||"")?`<div style="font-size:8px;color:#555;margin-top:1px">[${r.adjustReason}]</div>`:""}</td>
                            ...
                            {cust.groups.length>1&&custOpen&&(
                              <div style={{display:"flex",gap:4,justifyContent:"center",marginTop:4}}>
                                <button onClick={async()=>{
                                  ...
                                  nt.document.write("<!DOCTYPE html><html lang='ja'><head><meta charset='utf-8'><title>"+mtitle+"</title><style>"+lastCss+"\n@media print{.no-print{display:none!important}body{margin:0}.pb,.pb-last{padding-top:52px}}</style></head><body>");
